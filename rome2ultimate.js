    ...
    $(".mapcontainer").mapael({
        map: {
        	...
        	'stonehenge':{
        		x:142,
        		y:197,
        		tooltip:{content:"<b>Stonehenge</b><br><i>\"Their legacy remains, hewn into the living rock of Stonehenge.\"</i><br>+3% civil research rate<br>-20% public order penalties from cultural differences"},
        		value: "Wonders"
        	},
        	'karnag':{
        		x:117,
        		y:275,
        		tooltip:{content:"<b>The Dolmens of Karnag</b><br><i>\"Swirled in mist and mystery these stones have much to tell.\"</i><br>+3% military research rate<br>+2 growth per turn (global)"},
        		value: "Wonders"
        	},
        	'hercules':{
        		x:77,
        		y:534,
        		tooltip:{content:"<b>Pillars of Hercules</b><br><i>\"Great pillars created by the might of Hercules.\"</i><br>+5% movement range for all fleets<br>-3% naval unit recruitment cost"},
        		value: "Wonders"
        	},
        	'hercules2':{
        		x:77,
        	...
        	'vesuvius':{
        		x:352,
        		y:432,
        		tooltip:{content:"<b>Mount Vesuvius </b><br><i>\"Those living in the shadow of Vesuvius respect its power.\"</i><br>+3% morale for all armies and fleets<br>+2% wealth from agriculture(global)"},
        		value: "Wonders"
        	},
        	'etna':{
        		x:347,
        		y:523,
        		tooltip:{content:"<b>Mount Etna</b><br><i>\"Home of the mighty Hephaestus forge and prison to the monster Typhon.\"</i><br>+3% armour for all armies and fleets<br>+2% wealth from agriculture(global)"},
        		value: "Wonders"
        	},
        	'greatgods':{
        		x:515,
        		y:415,
        		tooltip:{content:"<b>The Sanctuary of the Great Gods</b><br><i>\"In the heart of the Sanctuary the Great Gods wait...\"</i><br>+2 growth per turn (global)<br>+3 cultural influence(global)"},
        		value: "Wonders"
        	},
        	'olympus':{
        		x:465,
        		y:455,
        		tooltip:{content:"<b>Mount Olympus</b><br><i>\"Home of the Gods and mightiest of mountains.\"</i><br>-20% public order penalties from cultural differences<br>Bread and Games Edict: +5% wealth generated by cultural buildings"},
        		value: "Wonders"
        	},
        	'zeus':{
        		x:450,
        		y:492,
        		tooltip:{content:"<b>Statue of Zeus at Olympia</b><br><i>\"It is a wonder, to look upon the face of a God.\"</i><br>+3% wealth from cultural buildings (global)<br>Bread and Games Edict: +6 public order"},
        		value: "Wonders"
        	},
        	'amunra':{
        		x:523,
        	...
        	'giza':{
        		x:566,
        		y:655,
        		tooltip:{content:"<b>The Necropolis of Giza</b><br><i>\"The swirling sands hold the greatest treasures.\"</i><br>-3% construction costs<br>+2% wealth from culture buildings"},
        		value: "Wonders"
        	},
        	'pharos':{
        		x:550,
        		y:635,
        		tooltip:{content:"<b>The Pharos of ALexandria</b><br><i>\"May its light be a beacon when all other lights go out.\"</i><br>+20 line of sight to fleets<br>+5% wealth from maritime commerce buildings"},
        		value: "Wonders"
        	},
        	'colossus':{
        		x:545,
